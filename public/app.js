...
async function printPass() {
    ...
    // AGGRESSIVE FIX: Clone ONLY the pass into a clean print window
    const passElement = document.querySelector('#printable-pass');
    if (!passElement) {
        console.error('No pass element found!');
        return;
    }
        ...
        <head>
            ...
            <style>
                ...
                * {
                ...
                .pass-footer-item strong {
                    font-size: 0.75rem;
                    font-weight: 600;
                    color: #000000;
                    font-family: 'Montserrat', sans-serif;
                }
                .pass-footer-item span {
                    font-size: 0.85rem;
                    font-weight: 500;
                    color: #000000;
                    font-family: 'Montserrat', sans-serif;
